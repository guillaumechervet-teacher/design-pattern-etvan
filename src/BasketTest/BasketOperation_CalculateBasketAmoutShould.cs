...
namespace BasketTest
{
    ...
    {
        public static int CalculateBasketAmountTotal(BasketOperation_CalculateBasketAmoutShould.BasketTest basketTest, int amountTotal)
        {
    ...
    public class BasketOperation_CalculateBasketAmoutShould
    {
        ...
        {
            var amountTotal = 0;
            amountTotal = ImperativeProgramming.CalculateBasketAmountTotal(basketTest, amountTotal);
